...
def test_util_ncdf():
    ...
    with TemporaryDirectory() as tmpdir:
        ...
        data_path = PurePosixPath("tests/snakemake_rules/util_ncdf/data")
        expected_path = PurePosixPath(
            "tests/snakemake_rules/util_ncdf/expected"
        )
        ...
        # dbg
        print(
            "data/interim/tests/24/H2O/11_GaMD_full/2/0/7f5696daa1cbe87d_traj.ncdf",
            file=sys.stderr,
        )
        ...
        to_delete = [
            "samples_old.tsv",
            "samples_tests.tsv",
            "data/interim/tests/24/H2O/11_GaMD_full/2/0/7f5696daa1cbe87d_traj.ncdf_ln.log",
        ]
        for d in to_delete:
