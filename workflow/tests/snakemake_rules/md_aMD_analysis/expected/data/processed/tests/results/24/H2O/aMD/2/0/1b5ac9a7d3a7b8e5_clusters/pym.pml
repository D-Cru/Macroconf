load data/processed/tests/results/24/H2O/aMD/2/0/1b5ac9a7d3a7b8e5_clusters/clusters.pdb
...
cmd.mpng("data/processed/tests/results/24/H2O/aMD/2/0/1b5ac9a7d3a7b8e5_clusters/test_", width=1000, height=1000)
